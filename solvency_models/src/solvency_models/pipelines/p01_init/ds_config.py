...
from solvency_models.pipelines.p01_init.mdl_info_config import ModelInfo, Target, ModelEnum
from solvency_models.pipelines.p01_init.metric_config import MetricEnum
...
class DataScienceConfig:
    ...
    def __init__(self, parameters: Dict, mdl_info: ModelInfo):
        ...
        if model_params["model_class"] is not None:
            ...
            self.model_class = f"solvency_models.pipelines.p07_data_science.models.{model_class_name}"
