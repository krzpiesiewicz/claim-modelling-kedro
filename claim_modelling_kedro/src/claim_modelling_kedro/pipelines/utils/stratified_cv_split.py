...
def _get_stratified_train_calib_test_cv(target_df: pd.DataFrame, stratify_target_col: str, cv_folds: int,
                                        shuffle: bool = True, random_seed: int = 0, verbose: bool = False,
                                        cv_type: str = 'train_test', cv_parts_names: list = None):
    """
...
def get_stratified_train_calib_test_cv(target_df: pd.DataFrame, stratify_target_col: str, cv_folds: int,
    ...
    return _get_stratified_train_calib_test_cv(target_df, stratify_target_col, cv_folds, shuffle, random_seed, verbose,
