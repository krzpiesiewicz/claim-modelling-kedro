        ...
        match mdl_info.target:
            case Target.CLAIMS_NUMBER:
                ...
                self.evaluation_metrics = [
                    ...
                    # MetricEnum.GINI,
                    MetricEnum.EXP_WEIGHTED_GINI,
                    # MetricEnum.ORDERED_GINI,
                    MetricEnum.EXP_WEIGHTED_ORDERED_GINI,
                    # MetricEnum.NORMALIZED_ORDERED_GINI,
                    MetricEnum.EXP_WEIGHTED_NORMALIZED_ORDERED_GINI]
            case Target.FREQUENCY:
                ...
                self.evaluation_metrics = [MetricEnum.POISSON_DEV, MetricEnum.EXP_WEIGHTED_POISSON_DEV,
                                           ...
                                           MetricEnum.GINI, MetricEnum.EXP_WEIGHTED_GINI,
                                           MetricEnum.ORDERED_GINI, MetricEnum.EXP_WEIGHTED_ORDERED_GINI,
                                           MetricEnum.NORMALIZED_ORDERED_GINI,
                                           MetricEnum.EXP_WEIGHTED_NORMALIZED_ORDERED_GINI]
            ...
            case Target.AVG_CLAIM_AMOUNT:
                ...
                self.evaluation_metrics = [
                    ...
                    # MetricEnum.GINI,
                    MetricEnum.CLNB_WEIGHTED_GINI,
                    # MetricEnum.ORDERED_GINI,
                    MetricEnum.CLNB_WEIGHTED_ORDERED_GINI,
                    # MetricEnum.NORMALIZED_ORDERED_GINI,
                    MetricEnum.CLNB_WEIGHTED_NORMALIZED_ORDERED_GINI]
